...
def addExamplesToPyLode(examples,filepath,basename=""):
    ...
    for img in images:
        ...
        filedata=filedata.replace("<code>https://w3id.org/geosrs/projection/"+img.replace(".svg","")+"</code></td>","<code>https://w3id.org/geosrs/projection/"+img.replace(".svg","")+"</code></td></tr><tr><th>Image</th><td><img src=\"https://raw.githubusercontent.com/situx/proj4rdf/refs/heads/main/resources/projection/"+img+"\" width=\"50%\"/></td>")
    for exx in examples:
