...
The suggested prefix for the SOSA namespace is geosrs.

The SOSA graph containing the core definitions is available at http://www.w3.org/ns/geosrs/.

The SSN graph with the full axiomatization of the core terms is available at http://www.w3.org/ns/geosrs/.
